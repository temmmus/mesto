...
import { formConfig } from "../utils/form-config.js";
import { initialCards } from "./initial-сards.js";
import { openPopup, closePopup } from "../utils/popup-functions.js";
...
function changeProfile(event) {
  ...
  pageElements.PROFILE_ABOUT.textContent =
    pageElements.PROFILE_ABOUT_INPUT.value;
...
function handleImageFormSubmit(event) {
  const cardElement = createCard(
    pageElements.PLACE_NAME_INPUT.value,
    pageElements.PLACE_LINK_INPUT.value,
    pageElements.CARD_TEMPLATE
  ); // создание карточки
...
addCardPopup.addEventListener("submit", handleImgaeFormSubmit);
